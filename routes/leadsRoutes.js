...
router.get('/', permitirRoles('super_admin', 'admin', 'coordinador', 'vendedora'), c.listar);
router.get('/vendedores', permitirRoles('super_admin', 'admin', 'coordinador', 'vendedora'), c.listarVendedores);
...
router.post('/:id/convertir', permitirRoles('super_admin', 'admin', 'vendedora'), c.convertir);
