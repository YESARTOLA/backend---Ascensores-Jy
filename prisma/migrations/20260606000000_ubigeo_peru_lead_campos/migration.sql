-- Catalogo oficial de ubigeo INEI (departamento/provincia/distrito) y nuevos
-- campos comerciales del lead: ubicacion del proyecto, tipo de ascensor,
-- correo, empresa del prospecto (razon social + RUC) y nombre del proyecto.

-- CreateTable
CREATE TABLE "tbl_ubigeo_peru" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "tbl_ubigeo_peru_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "tbl_ubigeo_peru_codigo_key" ON "tbl_ubigeo_peru"("codigo");

-- AlterTable
ALTER TABLE "tbl_leads" ADD COLUMN "codigo_ubigeo" VARCHAR(6),
ADD COLUMN "id_tipo_ascensor" INTEGER,
ADD COLUMN "correo" VARCHAR(150),
ADD COLUMN "razon_social" VARCHAR(200),
ADD COLUMN "ruc" VARCHAR(11),
ADD COLUMN "nombre_proyecto" VARCHAR(200);

-- AddForeignKey
ALTER TABLE "tbl_leads" ADD CONSTRAINT "tbl_leads_codigo_ubigeo_fkey" FOREIGN KEY ("codigo_ubigeo") REFERENCES "tbl_ubigeo_peru"("codigo") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tbl_leads" ADD CONSTRAINT "tbl_leads_id_tipo_ascensor_fkey" FOREIGN KEY ("id_tipo_ascensor") REFERENCES "tbl_tipos_ascensor"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- Datos oficiales INEI (1,893 distritos)
INSERT INTO "tbl_ubigeo_peru" ("codigo","departamento","provincia","distrito") VALUES
